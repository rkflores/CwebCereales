...
?>			
	...
	<td> <?php if($sell->user_id!=null){$c= $sell->getUser();echo $c->name." ".$c->lastname;} ?> </td>
		...
		<a  target="_blank" href="ticket.php?id=<?php echo $sell->id; ?>" class="btn btn-xs btn-default"><i class='fa fa-print'></i> Imprimir</a>
<?php if(isset($_SESSION["user_id"]) && Core::$user->kind==1):?>
		...
		<a href="index.php?view=delsell&id=<?php echo $sell->id; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"> Borrar</i></a>
<?php endif;?>
		</td>
	</tr>
