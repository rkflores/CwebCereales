...
<div class="row">
	...
	<p><b>Buscar producto por nombre o por codigo:</b></p>
		...
		<div class="row">
			<div class="col-md-3">
				...
				<input type="text" id="product_name" name="product_name" class="form-control" placeholder="Nombre del Producto o codigo de barras">
			</div>
   ...
   <select name="category_id" id="category_id" class="form-control">
    <option value="">-- SIN CATEOGORIA --</option>
