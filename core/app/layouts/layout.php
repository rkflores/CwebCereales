...
<?php if(Core::$user->kind==1):?>
                        <li><a href="./index.php?view=alerts"><i class='fa fa-bell'></i> <span>Pocas existencias</span></a></li>
<?php endif; ?>
<?php endif; ?>
...
<?php if(Core::$user->kind==1):?>
   ...
   <?php endif; ?>
            ...
            <li><a href="./?view=re"><i class='fa fa-plus-circle'></i>Abastecer</a></li>
<li><a href="./?view=selectstock"><i class='fa fa-share-square-o'></i>Traspasar</a></li>
<li><a href="./?view=newproduct"><i class='fa fa-cart-plus'></i>Nuevo producto</a></li>
                <li><a href="./?view=search"><i class='fa fa-search'></i></i> Buscar Productos</a></li>
          ...
          <li><a href="./?view=rescancel">Compras canceladas</a></li>
            ...
            <?php if(Core::$user->kind==1):?>
              ...
              <a href="#"><i class='fa fa-database'></i> <span>Datos</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
    ...
    <?php endif;?>
      ...
      <div class="content-wrapper">
        ...
        <strong>POS by &copy; <a href="http://contratistasweb.com/" target="_blank">Cweb</a></strong>
      </footer>
      <?php else:?>
